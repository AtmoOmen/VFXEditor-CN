        ...
        public UldKeyframe( KeyGroupType groupType ) {
            Data.AddRange( groupType switch {
                ...
                KeyGroupType.Float3 => new List<ParsedBase>() {
                    new ParsedFloat( "值 1" ), new ParsedFloat( "Value 2" ), new ParsedFloat( "Value 3" )
                },
                ...
                KeyGroupType.SByte2 => new List<ParsedBase>() {
                    new ParsedSByte( "值 1" ), new ParsedSByte( "Value 2" ),
                    new ParsedReserve( 2 )
                },
                KeyGroupType.SByte3 => new List<ParsedBase>() {
                    new ParsedSByte( "值 1" ), new ParsedSByte( "Value 2" ), new ParsedSByte( "Value 3" ),
                    new ParsedReserve( 1 )
                },
                ...
                KeyGroupType.Byte2 => new List<ParsedBase>() {
                    new ParsedInt( "值 1", size: 1 ), new ParsedInt( "Value 2", size: 1 ),
                    new ParsedReserve( 2 )
                },
                KeyGroupType.Byte3 => new List<ParsedBase>() {
                    new ParsedInt( "值 1", size: 1 ), new ParsedInt( "Value 2", size: 1 ), new ParsedInt( "Value 3", size: 1 ),
                    new ParsedReserve( 1 )
                },
                ...
                KeyGroupType.Short2 => new List<ParsedBase>() {
                    new ParsedShort( "值 1" ), new ParsedShort( "Value 2" ),
                    new ParsedReserve( 2 )
                },
                KeyGroupType.Short3 => new List<ParsedBase>() {
                    new ParsedShort( "值 1" ), new ParsedShort( "Value 2" ), new ParsedShort( "Value 3" ),
                    new ParsedReserve( 2 )
                },
                ...
                KeyGroupType.UShort2 => new List<ParsedBase>() {
                    new ParsedUInt( "值 1", size: 2 ), new ParsedUInt( "Value 2", size: 2 ),
                    new ParsedReserve( 2 )
                },
                KeyGroupType.UShort3 => new List<ParsedBase>() {
                    new ParsedUInt( "值 1", size: 2 ), new ParsedUInt( "Value 2", size: 2 ), new ParsedUInt( "Value 3", size: 2 ),
                    new ParsedReserve( 2 )
                },
                ...
                KeyGroupType.Int2 => new List<ParsedBase>() {
                    new ParsedInt( "值 1" ), new ParsedInt( "Value 2" )
                },
                KeyGroupType.Int3 => new List<ParsedBase>() {
                    new ParsedInt( "值 1" ), new ParsedInt( "Value 2" ), new ParsedInt( "Value 3" )
                },
                KeyGroupType.UInt1 => new List<ParsedBase>() {
                    new ParsedUInt( "值 1" )
                },
                KeyGroupType.UInt2 => new List<ParsedBase>() {
                    new ParsedUInt( "值 1" ), new ParsedUInt( "Value 2" )
                },
                KeyGroupType.UInt3 => new List<ParsedBase>() {
                    new ParsedUInt( "值 1" ), new ParsedUInt( "Value 2" ), new ParsedUInt( "Value 3" )
                },
                ...
                KeyGroupType.Bool2 => new List<ParsedBase>() {
                    new ParsedByteBool( "值 1" ), new ParsedByteBool( "Value 2" ),
                    new ParsedReserve( 2 )
                },
                KeyGroupType.Bool3 => new List<ParsedBase>() {
                    new ParsedByteBool( "值 1" ), new ParsedByteBool( "Value 2" ), new ParsedByteBool( "Value 3" ),
                    new ParsedReserve( 1 )
                },
                ...
                KeyGroupType.Label => new List<ParsedBase>() {
                    new ParsedUInt( "标签 ID", size: 2 ), new ParsedInt( "Label Command", size: 1 ), new ParsedInt( "Jump Id", size: 1 )
                },
